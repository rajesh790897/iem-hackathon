    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="https://hyprdevs.com/iem/temp/logo.png" alt="image" height="100" width="200"/></a> </div>
        </div>
...
echo "Welcome To HyprThings portal";
 } ?>
          </div>
        </div>
      </div>
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Products</a>
