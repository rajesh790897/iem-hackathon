...
<li><a href="#"><i class="fa fa-car"></i> Items</a>
					<ul>
						<li><a href="post-avehical.php">Add a Item</a></li>
						<li><a href="manage-vehicles.php">Manage Items</a></li>
					</ul>
				</li>

<li><a href="#"><i class="fa fa-sitemap"></i> Bookings</a>
					<ul>
						<li><a href="new-bookings.php">Panding</a></li>
				...
				<li><a href="testimonials.php"><i class="fa fa-table"></i> Manage review</a></li>
